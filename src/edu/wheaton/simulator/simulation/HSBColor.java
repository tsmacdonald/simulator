...
public class HSBColor {
    ...
    /**
     * Constructor
     * @param rgb A Color object to be converted to HSB
     */
     ...
     * @param sat The starting saturation
     * @param bri The beginning brightness
     */
    ...
    public void addColor(Color rgb) {
        Color.RGBtoHSB(rgb.getRed(), rgb.getGreen(), rgb.getBlue(),
                hsb);
    }
     ...
     * @param sat percentage from 0.0 to 1.0
     */
     ...
     * @param hue percentage from 0.0 to 1.0
     */
     ...
     * @param degree The new brightness level.
