 ...
 * 
 * Building block for the BoolExpression tree in the Trigger class. 
 * This class will be extended into BoolExpressionOperator and 
 * BoolExpressionComparison. This version simply contains an internal boolean
...
public class BoolExpression {
	...
	/**
	 * Parses string input and turns it into the tree representation of 
     * the boolean expression. Every operation should be of the form 
     * (x op y) and parenthesized. All variables must be "Primitive" 
     * (no booleans). Examples: ((x op y) op (z op k)), (((x op y) op z) op k).
