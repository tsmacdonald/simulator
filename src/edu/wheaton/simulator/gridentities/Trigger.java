...
public class Trigger implements Comparable<Trigger> {
	 ...
	 * @param conditions boolean expression this trigger represents
	 */
	 ...
	 * @param be Tree representing this trigger's fire conditions.
	 * @param result Models the outcome of the trigger being fired.
	 * @param owner The agent who owns this Trigger.
	 */
	public Trigger(int priority, Expression conditions, Behavior behavior, Agent owner) {
		this.priority = priority;
		this.conditions = conditions;
		this.behavior = behavior; 
		this.owner = owner;
