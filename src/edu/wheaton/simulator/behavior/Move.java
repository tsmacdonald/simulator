...
public class Move implements Behavable {
	...
	/**
	 * Main constructor
	 * @param global The Grid in which the Agent will move
	 * @param xExpr  The expression for the new x-coordinate
	 * @param yExpr  The expression for the new y-coordinate
	 */
	 ...
	 * If the slot it attempts to move to is already full, it throws an exception.
	 * It would be good if we could find a way to allow the user to say what happens
	 * when a FullSlotException is thrown.
	 */
	@Override
